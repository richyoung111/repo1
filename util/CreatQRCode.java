...
public class CreatQRCode {
	public static void main(String[] args) throws IOException {
		String text="CTR合同基本信息";
		String toPath="F:\\qrcode.png";
		createQRCode(text,toPath);
	}
	 ...
	 * @throws IOException 
	 */
	public static void createQRCode(String qrData,String toPath) throws IOException {
		 //计算二维码图片的高宽比
...
//        String qrData = "北京时代威驰信息技术有限公司";//内容信息
